globals [
  ...
  burned-trees-backburn
  erasing?
  backburn
]

breed [fires fire]    ;; bright red turtles -- the leading edge of the fire
breed [fires-b fire-b]    ;; bright red turtles -- the leading edge of the fire
breed [embers ember]  ;; turtles gradually fading from red to near black
breed [embers-b ember-b]  ;; turtles gradually fading from red to near black

to setup
  clear-all

;  import-pcolors "Documents/UCF/Fall 2022/CAP6675-CAS/jagged.jpeg"
;  ask patches with [pcolor > 9.0 and pcolor <= 9.9 and (random-float 100) < density] [set pcolor green]
;  ask patches with [pcolor = 9.9 ] [set pcolor black]
  ...
  ;;let zigzag "Documents/UCF/Fall 2022/CAP6675-CAS/zigzag-1.png"
  ;;let jagged "Documents/UCF/Fall 2022/CAP6675-CAS/thick-jagged.png"

  ;; creates the shape (maybe implement selector later)
  import-pcolors word "shapes/" shape-selector
  ask patches with [pcolor > 8.0 and pcolor <= 9.9 and (random-float 100) < density] [set pcolor green]
  ask patches with [pcolor = 9.9 ] [set pcolor black]
  ...
  set burned-trees 0
  set burned-trees-backburn 0
  reset-ticks
end

to go
;   import-pcolors "Documents/UCF/Fall 2022/CAP6675-CAS/zigzag.jpeg"
  ...
  ask fires-b
    [ ask neighbors4 with [pcolor = green]
      [ ignite-backburn ]
      set breed embers-b ]
  fade-embers-backburn

  ask patches with [pcolor > 43.0 and pcolor <= 47.0]
      [ignite-backburn]
;
;  ask fires-b
;    [ ask patches with [pcolor > 43.0 and pcolor <= 47.0]
...
;; creates fire turtles for back burn fire

to ignite-backburn  ;; patch procedure
  sprout-fires-b 1
    [ set color yellow ]
  set pcolor black
  set burned-trees-backburn burned-trees-backburn + 1
end

to draw-cells
  ifelse mouse-down? [
    if erasing? = 0 [
      set erasing? [any? turtles] of patch mouse-xcor mouse-ycor
    ]
  ...
  [
;    ask backburn [set pxcor pxcor + xcoord-offset]
    set erasing? 0
...
; achieve fading color effect for the fire as it burns
to fade-embers-backburn
  ask embers-b
    [ set color color - 0.3  ;; make red darker
      if color < yellow - 3.5     ;; are we almost at black?
        [ set pcolor color
          die ] ]
end
...
197
237
percent burned - backburn
(burned-trees-backburn / initial-trees)\n* 100
1
1
11
...
shape-selector
shape-selector
"line2.png" "zigzag2.png" "squiggle2.png" "line3.png" "zigzag3.png" "squiggle3.png"
5
