...
to update-signal  ;; turtle procedure
  ...
  show (list brooding-demand defense-demand foraging-demand)
...
;    set antCount forageCount + defenseCount + broodCount
  ...
  set broodingSignal (broodingSignal + 1 - (3 / antCount) * broodxsum )
  set broodingSignal max list 0.1 broodingSignal

  set foragingSignal (foragingSignal + 1 - (3 / antCount) * foragexsum )
  set foragingSignal max list 0.1 foragingSignal

  set defenseSignal (defenseSignal + 1 - (3 / antCount) * defensexsum )
